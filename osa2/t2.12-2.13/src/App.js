...
class App extends Component {
  ...
  render() {
    const countriesToShow = this.state.filter.length === 0 ? this.state.countries : this.state.countries.filter(country => country.name.toUpperCase().includes(this.state.filter.toUpperCase()))
    return (
      <div>
